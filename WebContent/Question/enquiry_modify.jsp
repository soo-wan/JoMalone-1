...
<body>
		<form action="/JoMalone/modifyConfirm.ask" method="post" id="modifyFrm">
		<div class=container id="modify-page">
			<div id="modify-title" class="row">
				<h4>1:1 ENQUIRY MODIFY</h4>
			</div>
			...
			<div class="row" id=titleBox style="height: 30px;">
				<div class="col-12 p-0">
					...
					<input type=text placeholder="제목을 입력해주세요." id="write-name" name="write-name" style="margin: 0px; padding: 0px 0px 0px 7px; width: 100%; height: 30px; text-align: left;" value="${readDTO.title }">
				</div>
			</div>
			...
			<div class="row" id=btnBox>
				<div class="col-12 p-0" style="text-align: center;">
					<input type="button" value="Cancel" id="cancel"> <input
						type="button" value="Modify" id="toModify">
				</div>
			</div>
		</div>
	</form>
