	 ...
	 -->
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          <ol class="carousel-indicators">
            ...
            <li data-target="#carouselExampleIndicators" data-slide-to="4" class="d-none d-lg-block"></li>
            <li data-target="#carouselExampleIndicators" data-slide-to="5" class="d-none d-lg-block"></li>
            <li data-target="#carouselExampleIndicators" data-slide-to="6" class="d-none d-lg-block"></li>
          </ol>
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="Resource/img/Main_event4.jpg" style="width:1140px; height: 500px;" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Resource/img/Main_event3.jpg" style="width:1140px; height: 500px;" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Resource/img/Main_event2.jpg" style="width:1140px; height: 500px;" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Resource/img/Main_event5.jpg" style="width:1140px; height: 500px;" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Resource/img/Main_event6.jpg" style="width:1140px; height: 500px;" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Resource/img/Main_event.jpg" style="width:1140px; height: 500px;" class="d-block w-100" alt="...">
            </div>
          </div>
