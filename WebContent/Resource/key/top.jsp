...
<style>
	...
	#title {padding: 30px 30px 30px 100px;  font-family: 'Alata', sans-serif; float:left; width:990px; height:160px; text-align:center;}
	...
	#top-two {padding: 0px; height: 40px; background-color: #F6F6F6; line-height:40px;}
	#navbar {padding: 0px;  width:1140px; height: 40px; margin:auto;}
	
	#nav-ul { padding: 0px; height: 40px; list-style: none; }
	.nav-item { float:left; width:190px; height: 100%; line-height:40px;text-align: center; list-style-type: none;}
	.nav-link {color: #5D5D5D; padding:0px;width:100%; display:block;text-decoration:none; height:40px; text-align: center;}
...
<body>
    ...
    <div id="top-two" class="container"">
        <div id="navbar"  style=" list-style: none;">
			<ul id="nav-ul">
				 <li class="nav-item">
