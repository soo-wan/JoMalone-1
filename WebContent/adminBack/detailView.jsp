                        ...
                        <form action="${pageContext.request.contextPath}/modifyDetail.admini" method="post" id="frm" enctype="multipart/form-data">
                            <table>
                                <tr>
                                    ...
                                    <td class=secondCol><input type="text" id="category" name="category" value="${Product.category}" disabled="disabled" class=secondCol_inner></td>
                                    <td rowspan="10"><img id="img" src=""></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>상품 코드</td>
                                    <td class=secondCol><input type="text" id="productCode" name="productCode" value="${Product.productCode}" disabled="disabled" class=secondCol_inner></td>
                                    <input type="text" id="oriCode" name="oriCode" value="${Product.productCode}" >
                                </tr>
                                <tr>
                                    <td class=firstCol>상품명</td>
                                    <td class=secondCol><input type="text" id="productName" name="productName" value="${Product.productName}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>가격</td>
                                    <td class=secondCol><input type="text" id="price" name="price" value="${Product.price}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>수량</td>
                                    <td class=secondCol><input type="text" id="quantity" name="quantity" value="${Product.quantity}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                                <tr>
                                    <td name=ingredients class=firstCol>전성분
                                    <td class=secondCol><textarea id="ingredients" name="ingredients" class=secondCol_inner>${Product.ingredients}</textarea>
                                </tr>
                                <tr>
                                    <td class=firstCol>상품 설명</td>
                                    <td class=secondCol><textarea id="description" name="description" value="" disabled="disabled" class=secondCol_inner>${Product.description}</textarea></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>spring</td>
                                    <td class=secondCol><input type="text" id="spring" name="spring" value="${Product.spring}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>summer</td>
                                    <td class=secondCol><input type="text" id="summer" name="summer" value="${Product.summer}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>fall</td>
                                    <td class=secondCol><input type="text" id="fall" name="fall" value="${Product.fall}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>winter</td>
                                    <td class=secondCol><input type="text" id="winter" name="winter" value="${Product.winter}" disabled="disabled" class=secondCol_inner></td>
                                </tr>
                            </table>
