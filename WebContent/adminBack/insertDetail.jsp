	...
	<div id="container">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input id="prod_name" disabled="disabled">
                        </tr>
                        <tr>
                            <td class=firstCol>가격
                            <td><input id="prod_price" disabled="disabled">
                        </tr>
                        <tr>
                            <td class=firstCol>수량
                            <td><input id="prod_quantity" disabled="disabled">
                        </tr>
                        <tr>
                            <td class=firstCol>전성분
                            <td><textarea id="ingredients" name=ingredients></textarea>
                        </tr>
                        <tr>
                            <td class=firstCol>상품 설명
                            <td><textarea id="prod_description" disabled="disabled"></textarea>
                        </tr>
                        <tr>
                            <td class=firstCol>spring</td>
                            <td><input type="text" id="spring" disabled="disabled"></td>
                        </tr>
                        <tr>
                            <td class=firstCol>summer</td>
                            <td><input type="text" id="summer" disabled="disabled"></td>
                        </tr>
                        <tr>
                            <td class=firstCol>fall</td>
                            <td><input type="text" id="fall" disabled="disabled"></td>
                        </tr>
                        <tr>
                            <td class=firstCol>winter</td>
                            <td><input type="text" id="winter" disabled="disabled"></td>
                        </tr>
                    </table>
                ...
                <script>
                    $("#category").on("change",function(){
                        $(".option").remove();
                        $.ajax({
                            url:"${pageContext.request.contextPath}/getProductCode.admini",
                            type:"post",
                            data:{category:$(this).val()}
                        }).done(function(data){ 
                            var optionLabel = $("<option id='optionLabel' class='option' value='' selected disabled>상품코드</option>");
                            $("#codeSelectBox").append(optionLabel);
                            codeList = JSON.parse(data);
                            for(var code in codeList){
                                var option = $("<option class='option' value='"+codeList[code]+"'>"+codeList[code]+"</option>");
                                $("#codeSelectBox").append(option);
                            }
                        }).fail(function(){
                    ...
                    $("#codeSelectBox").on("change",function(){
                        var productCode = $(this).find($("option:selected")).val();
                        $.ajax({
                            url:"${pageContext.request.contextPath}/getProductInfo.admini",
                            type:"post",
