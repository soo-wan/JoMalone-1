...
<body>
	...
	<div class="container">
		<div class="row" style="margin-bottom: 130px;">
			<img src="/JoMalone/Resource/img/fruits-main.jpg" style="margin: 10px 0px 10px 0px; width: 100%;">
			<div style="width: 100%; height: 0px;">
				<div style="position: relative; bottom: 130px; width: 100%; height: 70px; text-align: center; background-color: #E4F7BA; opacity: 0.6;"></div>
				<div style="position: relative; bottom: 195px; width: 100%; height: 70px; text-align: center;">
					<h4 style="line-height: 35px;">프루티 코롱</h4>
					<h6 style="line-height: 20px;">순식간에 퍼져나가는 달콤하고 감미로운 매력의 과일 향</h6>
				</div>
			</div>
		</div>
		...
		<div class="row" style="margin-bottom: 130px; border: 1px solid green;">
			<div style="margin: 10px auto 20px auto; width: 300px; height: 300px; border: 1px solid red; text-align: center;">
				<img src="/JoMalone/Resource/img/Fr001.jpg">
				<h5 style="margin: 10px 0px 10px 0px; font-size: 17px;">잉글리쉬 페어 앤 프리지아 코롱</h5>
