    ...
    <html>
        ...
        <body>
            ...
            <form action=${pageContext.request.contextPath}/insert.ca method=post id="frm">
                ...
                <div class="container" style="margin: 70px auto 70px auto; height: 600px; background-color: #FFD8D8;">
