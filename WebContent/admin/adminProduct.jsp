                        ...
                        <form action="${pageContext.request.contextPath}/insertProduct.admini" method="post" id="frm" enctype="multipart/form-data">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class=secondCol><input type="text" name="productName"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>가격</td>
                                    <td class=secondCol><input type="text" name="price"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>수량</td>
                                    <td class=secondCol><input type="text" name="quantity"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>상품 정보</td>
                                    <td class=secondCol><textarea type="text" name="description"></textarea></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>spring</td>
                                    <td class=secondCol><input type="text" name="spring"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>summer</td>
                                    <td class=secondCol><input type="text" name="summer"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>fall</td>
                                    <td class=secondCol><input type="text" name="fall"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>winter</td>
                                    <td class=secondCol><input type="text" name="winter"></td>
                                </tr>
                                <tr>
                                    <td class=firstCol>상품 이미지</td>
                                    <td class=secondCol><input type="file" name="img" id=prodImg></td>
                                </tr>
                                <tr>
