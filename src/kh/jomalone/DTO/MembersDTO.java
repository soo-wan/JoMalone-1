...
public class MembersDTO {
   ...
   private String year, month, day, agree_s, agree_p, blackdate;
   private Timestamp enrolldate,lastlogin;
   ...
   public MembersDTO(String id, String logintype, String pw,String name, String phone, String email, String zip_code,
         String address1, String address2, String birth, String gender,Timestamp enrolldate, Timestamp lastlogin, String black_yn,String blackdate,String agree_s, String agree_p) {
      super();
      this.id = id;
   ...
   public MembersDTO(String id, String logintype, String pw, String name, String phone1,
         ...
         Timestamp enrolldate, Timestamp lastlogin, String black_yn, String blackdate, String agree_s, String agree_p) {
      super();
      this.id = id;
      this.logintype = logintype;
      this.pw = pw;
   ...
   public MembersDTO(String id, String name, String phone1,
	         String phone2, String phone3, String email1, String email2, String zip_code, String address1,
	         String address2,  String year, String month, String day, String gender,
	          String black_yn, String blackdate) {
	      super();
	      this.id = id;
	      this.name = name;
	      this.phone1 = phone1;
